declare global {
  ...
  const dbQuery: typeof import('../../server/utils/db').dbQuery
  ...
  const getBotSettings: typeof import('../../server/utils/luna-dashboard').getBotSettings
  const getCookie: typeof import('../../node_modules/h3').getCookie
  const getGuildDashboard: typeof import('../../server/utils/luna-dashboard').getGuildDashboard
  const getHeader: typeof import('../../node_modules/h3').getHeader
  const getHeaders: typeof import('../../node_modules/h3').getHeaders
  const getMariaPool: typeof import('../../server/utils/db').getMariaPool
  ...
  const getUserPersonalization: typeof import('../../server/utils/luna-dashboard').getUserPersonalization
  ...
  const saveBotSetting: typeof import('../../server/utils/luna-dashboard').saveBotSetting
  const saveGuildSettings: typeof import('../../server/utils/luna-dashboard').saveGuildSettings
  const saveLVoiceConfig: typeof import('../../server/utils/luna-dashboard').saveLVoiceConfig
  const saveUserPersonalization: typeof import('../../server/utils/luna-dashboard').saveUserPersonalization
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'G:/github/Lunaby/dashboard/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'G:/github/Lunaby/dashboard/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getMariaPool, dbQuery } from 'G:/github/Lunaby/dashboard/server/utils/db';
export { getGuildDashboard, getBotSettings, saveBotSetting, saveGuildSettings, saveLVoiceConfig, getUserPersonalization, saveUserPersonalization } from 'G:/github/Lunaby/dashboard/server/utils/luna-dashboard';