...
const createProfileStructure = (userId) => ({
    ...
    data: {
        ...
        profile: {
            ...
            birthday: null,
            inventory: [],
            social: { twitter: null, youtube: null, twitch: null, website: null },
            custom_status: null,
            badges: [],
            frame: null,
            effect: null,
        ...
        economy: {
            bank: null,
            wallet: null,
            streak: { alltime: 0, current: 0, timestamp: 0 },
            shard: null,
        },
        reputation: { points: 0, givenBy: [], lastGiven: 0 },
        tips: { given: 0, received: 0, timestamp: 0 },
        xp: [],
